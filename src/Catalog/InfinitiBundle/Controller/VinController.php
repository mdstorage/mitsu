...
use Catalog\InfinitiBundle\Controller\Traits\InfinitiVinFilters;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpFoundation\Response;
class VinController extends BaseController{
    use InfinitiVinFilters;
    public function bundle()
    {
        return 'CatalogInfinitiBundle:Vin';
    }

    public function model()
    {
        return $this->get('infiniti.vin.model');
    }
    ...
    public function resultAction(Request $request)
    {
        if ($request->isXmlHttpRequest()) {
            ...
            setcookie(InfinitiConstants::INTCOLOR, $result[ InfinitiConstants::INTCOLOR]);
    ...
    public function articulsAction(Request $request)
    {
        if ($request->isXmlHttpRequest()) {
            ...
            $color = $request->cookies->get(InfinitiConstants::INTCOLOR);
