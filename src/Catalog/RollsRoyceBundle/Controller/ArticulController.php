<?php
namespace Catalog\RollsRoyceBundle\Controller;


use Catalog\CommonBundle\Components\Constants;
use Catalog\CommonBundle\Controller\ArticulController as BaseController;
use Symfony\Component\HttpFoundation\Request;
use Catalog\RollsRoyceBundle\Controller\Traits\RollsRoyceArticulFilters;
use Catalog\CommonBundle\Components\Factory;

class ArticulController extends BaseController{
use RollsRoyceArticulFilters;
    public function bundle()
    {
        return 'CatalogRollsRoyceBundle:Articul';
    }

    public function model()
    {
        return $this->get('rollsroyce.articul.model');
    }
   ...
   /* public function modificationsAction(Request $request)
    ...
    public function rollsroyceArticulcomplectations1Action(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $articul = null, $token = null)
    {
        $parameters = $this->getActionParams(__CLASS__, __FUNCTION__, func_get_args());
    ...
    public function rollsroyceArticulcomplectation_korobkaAction(Request $request)
    {
    ...
    public function rollsroyceArticulcomplectation_yearAction(Request $request)
    {
    ...
    public function rollsroyceArticulcomplectation_monthAction(Request $request)
    {
        if ($request->isXmlHttpRequest()) {
    ...
    public function rollsroyceArticulGroupsAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $articul = null, $token = null)
    {
    ...
    public function rollsroyceArticulSubgroupsAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $groupCode = null, $articul = null, $token = null)
    {
    ...
    public function rollsroyceArticulSchemasAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $groupCode = null, $subGroupCode = null, $articul = null, $token = null)
    {
    ...
    public function rollsroyceArticulSchemaAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $groupCode = null, $subGroupCode = null, $schemaCode = null, $articul = null, $token = null)
    {
