...
use FordArticulFilters;
    ...
    public function fordArticulcomplectations1Action(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null)
    {
    ...
    public function fordArticulcomplectation_korobkaAction(Request $request)
    {
        $articul = $request->cookies->get(Constants::ARTICUL);
    ...
    public function fordArticulcomplectation_yearAction(Request $request)
    {
        $articul = $request->cookies->get(Constants::ARTICUL);
        if ($request->isXmlHttpRequest()) {
    ...
    public function fordArticulcomplectation_monthAction(Request $request)
    {
        $articul = $request->cookies->get(Constants::ARTICUL);
        if ($request->isXmlHttpRequest()) {
    ...
    public function fordArticulGroupsAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null)
    {
        $articul = $request->cookies->get(Constants::ARTICUL);
    ...
    public function fordArticulSubgroupsAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $groupCode = null)
    {
        $articul = $request->cookies->get(Constants::ARTICUL); 
    ...
    public function fordArticulSchemasAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $groupCode = null, $subGroupCode = null)
    {
        $articul = $request->cookies->get(Constants::ARTICUL);
    ...
    public function fordArticulSchemaAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $groupCode = null, $subGroupCode = null, $schemaCode = null)
    {
        $articul = $request->cookies->get(Constants::ARTICUL);
