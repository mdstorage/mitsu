...
class HyundaiArticulModel extends HyundaiCatalogModel{
    ...
    public function getArticulComplectations($articul, $regionCode, $modelCode, $modificationCode)
    {
        ...
        /*Отфильтруем коды комплектаций по колонке cats_dat_parts.compatibility в фильтре filterComplectations() из HyundaiCatalogModel*/
        foreach ($aData as $item){
