...
class SkodaCatalogModel extends CatalogModel{
    ...
    public function getGroups($regionCode, $modelCode, $modificationCode, $complectationCode)
    {
        ...
        WHERE all_hg.hgts = all_duden.ts and all_hg.hg = :item and all_hg.catalog = 'sk' and all_duden.catalog = all_hg.catalog and all_duden.lang = 'R'
        ";
...
$articuls = array();
    ...
    public function getDesc($sitemCode, $language)
    {
        ...
        SELECT text
        FROM all_duden
        WHERE :item = all_duden.ts and all_duden.catalog = 'sk' and all_duden.lang = 'R'
        ";
