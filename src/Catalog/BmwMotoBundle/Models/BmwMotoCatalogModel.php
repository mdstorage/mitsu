...
namespace Catalog\BmwMotoBundle\Models;
...
class BmwMotoCatalogModel extends CatalogModel{
    ...
    public function getRegions(){
        ...
        FROM w_fztyp
        WHERE fztyp_karosserie LIKE 'ohne'
    ...
    public function getModels($regionCode)
    {
        ...
        AND fztyp_ktlgausf = :regionCode AND baureihe_marke_tps = 'BMW' AND fztyp_karosserie LIKE 'ohne'
