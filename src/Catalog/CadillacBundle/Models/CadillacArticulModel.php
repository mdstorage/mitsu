...
namespace Catalog\CadillacBundle\Models;

use Catalog\CommonBundle\Components\Constants;
use Catalog\CadillacBundle\Components\CadillacConstants;

class CadillacArticulModel extends CadillacCatalogModel{
    ...
    public function getArticulModels ($articul, $regionCode)
    {
        ...
        and (model.MAKE_DESC = 'Cadillac' OR model.MAKE_DESC = 'Lt Truck Cadillac'))
