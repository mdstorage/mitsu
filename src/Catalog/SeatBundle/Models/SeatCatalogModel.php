...
class SeatCatalogModel extends CatalogModel{
    ...
    public function getGroups($regionCode, $modelCode, $modificationCode, $complectationCode)
    {
        ...
        WHERE all_hg.hgts = all_duden.ts and all_hg.hg = :item and all_hg.catalog = 'se' and all_duden.catalog = all_hg.catalog and all_duden.lang = 'R'
        ";
