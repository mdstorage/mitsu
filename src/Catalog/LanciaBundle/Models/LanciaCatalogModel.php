...
namespace Catalog\LanciaBundle\Models;


use Catalog\CommonBundle\Components\Constants;
use Catalog\CommonBundle\Models\CatalogModel;
use Catalog\LanciaBundle\Components\LanciaConstants;

class LanciaCatalogModel extends CatalogModel{
    ...
    public function getModels($regionCode)
    {
        ...
        and comm_modgrp.mk2_cod LIKE 'L'
