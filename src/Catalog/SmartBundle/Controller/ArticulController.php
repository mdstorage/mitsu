...
use Catalog\SmartBundle\Controller\Traits\ArticulFilters;
...
class ArticulController extends BaseController{
    ...
    {
        return 'CatalogSmartBundle:Articul';
    }

    public function model()
    {
        return $this->get('smart.articul.model');
    }
    ...
    public function smartArticulGroupsAction(
        Request $request,
        $regionCode = null,
        $modelCode = null,
