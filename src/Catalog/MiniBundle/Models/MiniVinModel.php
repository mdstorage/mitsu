...
class MiniVinModel extends MiniCatalogModel
{
...
inner join w_baureihe on (fztyp_baureihe = baureihe_baureihe AND w_baureihe.baureihe_marke_tps = 'Mini')
