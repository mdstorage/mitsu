<?php
namespace Catalog\AbarthBundle\Controller;

use Catalog\CommonBundle\Components\Factory;
use Catalog\CommonBundle\Components\Constants;
use Catalog\CommonBundle\Controller\ArticulController as BaseController;
use Symfony\Component\HttpFoundation\Request;
use Catalog\AbarthBundle\Controller\Traits\AbarthVinFilters;

class ArticulController extends BaseController{
use AbarthVinFilters;
    public function bundle()
    {
        return 'CatalogAbarthBundle:Articul';
    }

    public function model()
    {
        return $this->get('abarth.articul.model');
    }

    public function bundleConstants()
    {
        return 'Catalog\AbarthBundle\Components\AbarthConstants';
    }
    ...
    public function abarthArticulComplectationsAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $articul = null, $token = null)
    {
    ...
    public function abarthArticulGroupsAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $articul = null, $token = null)
    {
    ...
    public function abarthArticulSubgroupsAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $groupCode = null, $articul = null, $token = null)
    {
    ...
    public function abarthArticulSchemasAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $groupCode = null, $subGroupCode = null, $articul = null, $token = null)
    {
    ...
    public function abarthArticulSchemaAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $groupCode = null, $subGroupCode = null, $schemaCode = null, $articul = null, $token = null)
    {
    ...
    public function abarthArticularticulsAction(Request $request)
    {
