...
use Catalog\MitsubishiBundle\Controller\Traits\MitsubishiVinFilters;

class ArticulController extends BaseController{
use MitsubishiVinFilters;
    public function bundle()
    {
        return 'CatalogMitsubishiBundle:Articul';
    }

    public function model()
    {
        return $this->get('mitsubishi.articul.model');
    }

    public function bundleConstants()
    {
        return 'Catalog\MitsubishiBundle\Components\MitsubishiConstants';
    }
    ...
    public function mitsubishiArticulComplectationsAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $articul = null, $token = null)
    {
    ...
    public function mitsubishiArticulGroupsAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $articul = null, $token = null)
    {
    ...
    public function mitsubishiArticulSubgroupsAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $groupCode = null, $articul = null, $token = null)
    {
    ...
    public function mitsubishiArticulSchemasAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $groupCode = null, $subGroupCode = null, $articul = null, $token = null)
    {
    ...
    public function mitsubishiArticulSchemaAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $groupCode = null, $subGroupCode = null, $schemaCode = null, $articul = null, $token = null)
    {
    ...
    public function mitsubishiArticularticulsAction(Request $request)
    {
