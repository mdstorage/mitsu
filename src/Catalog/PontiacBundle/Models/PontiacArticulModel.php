...
namespace Catalog\PontiacBundle\Models;

use Catalog\CommonBundle\Components\Constants;
use Catalog\PontiacBundle\Components\PontiacConstants;

class PontiacArticulModel extends PontiacCatalogModel{
    ...
    public function getArticulModels ($articul, $regionCode)
    {
        ...
        and (model.MAKE_DESC = 'Pontiac' OR model.MAKE_DESC = 'Lt Truck Pontiac'))
