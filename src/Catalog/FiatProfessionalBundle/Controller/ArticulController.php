<?php
namespace Catalog\FiatProfessionalBundle\Controller;

use Catalog\CommonBundle\Components\Factory;
use Catalog\CommonBundle\Components\Constants;
use Catalog\CommonBundle\Controller\ArticulController as BaseController;
use Symfony\Component\HttpFoundation\Request;
use Catalog\FiatProfessionalBundle\Controller\Traits\FiatProfessionalVinFilters;

class ArticulController extends BaseController{
use FiatProfessionalVinFilters;
    public function bundle()
    {
        return 'CatalogFiatProfessionalBundle:Articul';
    }

    public function model()
    {
        return $this->get('fiatprofessional.articul.model');
    }

    public function bundleConstants()
    {
        return 'Catalog\FiatProfessionalBundle\Components\FiatProfessionalConstants';
    }
    ...
    public function fiatprofessionalArticulComplectationsAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $articul = null, $token = null)
    {
    ...
    public function fiatprofessionalArticulGroupsAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $articul = null, $token = null)
    {
    ...
    public function fiatprofessionalArticulSubgroupsAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $groupCode = null, $articul = null, $token = null)
    {
    ...
    public function fiatprofessionalArticulSchemasAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $groupCode = null, $subGroupCode = null, $articul = null, $token = null)
    {
    ...
    public function fiatprofessionalArticulSchemaAction(Request $request, $regionCode = null, $modelCode = null, $modificationCode = null, $complectationCode = null, $groupCode = null, $subGroupCode = null, $schemaCode = null, $articul = null, $token = null)
    {
    ...
    public function fiatprofessionalArticularticulsAction(Request $request)
    {
