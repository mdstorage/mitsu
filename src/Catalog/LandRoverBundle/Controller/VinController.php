...
use Catalog\LandRoverBundle\Controller\Traits\LandRoverVinFilters;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpFoundation\Response;
class VinController extends BaseController{
    use LandRoverVinFilters;
    public function bundle()
    {
        return 'CatalogLandRoverBundle:Vin';
    }

    public function model()
    {
        return $this->get('landrover.vin.model');
    }
 ...
 /*   public function resultAction(Request $request)
    ...
    public function articulsAction(Request $request)
    {
        if ($request->isXmlHttpRequest()) {
            ...
            $color = $request->cookies->get(LandRoverConstants::INTCOLOR);
